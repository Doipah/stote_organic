...
@IonicPage()
@Component({
  selector: 'page-list-product1',
  templateUrl: 'list-product1.html',
})
export class ListProduct1Page {
  public prodect2: any[];
  ...
  ionViewDidLoad() {
    ...
    this.id_category_product = this.navParams.get('id_category_product');
    this.ti=this.navParams.get('title_cate');
    console.log("id_category_product",this.ti);
    this.showproductgroup1_data();
  ...
  showproductgroup1_data() {
    this.https.get('https://adminshop.kwanpat.com/admin-2-gh-pages/API_shop/select_group1_list01.php?id_category_product=' + this.id_category_product)
      .map(res => res.json())
      .subscribe(data => {
        this.prodect2 = data;
