...
/**
 * Generated class for the HistorycodePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-historycode',
  templateUrl: 'historycode.html',
})
export class HistorycodePage {
  ...
  ionViewDidLoad(position: string) {
    console.log('ionViewDidLoad HistorycodePage');
    ...
    this.ti_ti = this.navParams.get('ti_ti');
    this.tex = this.navParams.get('tex');
    console.log("COde", this.ti_ti)
  ...
  //   console.log("OK", code, this.total)
  //   this.navCtrl.push(ShowproductPage, { code: code, total: this.total })
  // }
  Trackparcel(){
  this.navCtrl.push(EtrackingsPage,{code:this.code_id})
  }
